...
class ContentDefinitionAddRemoveViewTest(object):
    ...
    DEF = content_view_definition_data.COMPOSITE_DEFS[0]
    ...
    def setUp(self):
        ...
        self.mock(self.module, 'get_composite_cv_definition', self.DEF)
    ...
    def test_it_returns_with_error_if_no_def_was_found(self):
        self.mock(self.module, 'get_composite_cv_definition').side_effect = ApiDataError()
