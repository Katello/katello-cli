...
from katello.client.core.node import RemoveEnvironment 
...
class NodeSyncTest(CLIActionTestCase):
    ...
    def setUp(self):
        self.NODE['environment_ids'] = [self.ENV['id']]
        self.set_action(RemoveEnvironment())
    ...
    def test_it_adds_env(self):
        ...
        self.run_action()       
        self.action.api.set_environments.assert_called_once_with(self.NODE['id'], [])
